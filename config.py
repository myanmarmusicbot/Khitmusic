...
POST_CHANNEL_ID = int(getenv("POST_CHANNEL_ID", "-1002711269497"))
...
# Git
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/khithlainhtet/Khitmusic")
...
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/ffsk8y.jpg")
